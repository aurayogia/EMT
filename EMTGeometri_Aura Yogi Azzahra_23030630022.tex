...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-004.png}
...
>A=[-1,1]; plotPoint(A,"A"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-005.png}
\begin{eulerprompt}
>B=[1,-1]; plotPoint(B,"B"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-006.png}
\begin{eulerprompt}
>C=[3,3]; plotPoint(C,"C"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-007.png}
\begin{eulerprompt}
>plotSegment(A,B,"a")
>plotSegment(B,C,"b")
>plotSegment(A,C,"c")
>aspect(1):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-008.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-009.png}
\begin{eulerprompt}
...
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segitiga ABC"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-010.png}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-012-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-014-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-020-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-024.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-026.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-039.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-043-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-044.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-051-large.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
{\it distance}\left({\it lineIntersection}\left(  {\it middlePerpendicular}\left(\left[ \frac{-c^2+b^2+a^2}{2\,a} ,   \frac{\sqrt{-c+b+a}\,\sqrt{c-b+a}\,\sqrt{c+b-a}\,\sqrt{c+b+a}}{2\,a}   \right]  , \left[ 0 , 0 \right] \right) , {\it middlePerpendicular}  \left(\left[ 0 , 0 \right]  , \left[ a , 0 \right] \right)\right) ,   \left[ 0 , 0 \right] \right)
\]
\end{eulerformula}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  Use global variables or parameters for string evaluation.
  Error in ^
  Error in expression: lineIntersection(middlePerpendicular([-(c^2-b^2-a^2)/(2*a),sqrt(-c^4+2*b^2*c^2+2*a^2*c^2-b^4+2*a^2*b^2-a^4)/(2*a)],[0,0]),middlePerpendicular([0,0],[a,0]))
  Error in:
...
\begin{eulerformula}
\[
\frac{c^2}{\sin ^2{\it computeAngle}\left(\left[ \frac{-c^2+b^2+a^2  }{2\,a} , \frac{\sqrt{-c^4-\left(-2\,b^2-2\,a^2\right)\,c^2-b^4+2\,a  ^2\,b^2-a^4}}{2\,a} \right]  , \left[ 0 , 0 \right]  , \left[ a , 0   \right] \right)}
\]
\end{eulerformula}
...
\begin{eulerformula}
\[
{\it areaTriangle}\left(\left[ -1 , -1 \right]  , \left[ 2 , 0   \right]  , \left[ 1 , 2 \right] \right)
\]
\end{eulerformula}
\begin{eulercomment}
...
\begin{eulerformula}
\[
{\it getLineEquation}\left({\it lineThrough}\left(\left[ -1 , -1   \right]  , \left[ 2 , 0 \right] \right) , x , y\right)
\]
\end{eulerformula}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-058-large.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Plot the circle and its center. Cu and U are symbolic. We evaluate
these expressions for Euler.
\end{eulercomment}
\begin{eulerprompt}
>plotCircle(LL()); plotPoint(O(),"O"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-061.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Tambahkan ke dalam plot kita.
\end{eulercomment}
\begin{eulerprompt}
>plotPoint(H(),"H"); plotLine(el(),"Garis Euler"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-071.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-075.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-078-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-081-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-082.png}
\begin{eulercomment}
Tentu saja,
...
agasan pertama trigonometri rasional adalah kuadrat, yang menggantikan
jarak. Sebenarnya, ini hanyalah jarak yang dikuadratkan. Berikut ini,
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-090-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-095.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-098-large.png}
\eulerimg{0}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-099-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-106-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-115-large.png}
...
\end{eulerformula}
\begin{eulercomment}
Karena penyebaran sudut negaatif adalah sama, aturan triple spread
juga berlaku, jika
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-123-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-125.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-127-large.png}
\eulerimg{2}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-128-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-130.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-135.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{eulercomment}
Radiusnya/ jari-jarinya memang 1.
\end{eulercomment}
\begin{eulerprompt}
>periradius(a,b,c)
\end{eulerprompt}
...
antara titik tetap A dan M, memiliki garis-garis tingkat yang agak
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-139.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-140.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-141.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-142.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-143.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-144.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-145.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-146.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-147.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-148.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-149.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-150.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-151.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-152.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-156.png}
...
\end{euleroutput}
\begin{eulercomment}
Kami menyiapkan adegan dengan tepat.
\end{eulercomment}
\begin{eulerprompt}
...
>povend();
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-157.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-158.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-159.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-160.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-161.png}
\begin{eulerprompt}
>A=[-2,-2]; plotPoint(A,"A"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-162.png}
\begin{eulerprompt}
>B=[2,-2]; plotPoint(B,"B"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-163.png}
\begin{eulerprompt}
>C=[0,3]; plotPoint(C,"C"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-164.png}
\begin{eulerprompt}
>plotSegment(A,B,"a"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-165.png}
\begin{eulerprompt}
>plotSegment(B,C,"b"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-166.png}
\begin{eulerprompt}
>plotSegment(A,C,"c"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-167.png}
\begin{eulerprompt}
...
>plotPoint(O,"O"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-168.png}
\begin{eulerprompt}
>l=angleBisector(A,B,C);
>color(2); plotLine(l); color(1):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-169.png}
\begin{eulerprompt}
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-170.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-171.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-172.png}
\begin{eulercomment}
...
>setPlotRange(-3.5,3.5,-3.5,3.5):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-173.png}
\begin{eulerprompt}
>A=[-2,-2]; plotPoint(A,"A"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-174.png}
\begin{eulerprompt}
>B=[2,-2]; plotPoint(B,"B"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-175.png}
\begin{eulerprompt}
>C=[2,2]; plotPoint(C,"C"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-176.png}
\begin{eulerprompt}
>D=[-2,2]; plotPoint(D,"D"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-177.png}
\begin{eulerprompt}
>plotSegment(A,B,"");
>plotSegment(B,C,"");
>plotSegment(C,D,"");
...
>aspect(1):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-178.png}
\begin{eulerprompt}
>l=angleBisector(A,B,C);
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-179.png}
\begin{eulerprompt}
>r=norm(P-projectToLine(P,lineThrough(A,B)));
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segiempat ABCD"):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-180.png}
\begin{eulerprompt}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-183.png}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-184.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-185.png}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-186.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{30}{images/EMTGeometri_Aura Yogi Azzahra_23030630022-187.png}
\end{eulernotebook}
\end{document}
