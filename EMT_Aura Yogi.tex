...
\end{eulercomment}
\eulersubheading{Perintah Baru 1}
\begin{eulerprompt}
>a:=5, b:=7, c:=2, (a^c)*b
\end{eulerprompt}
\begin{euleroutput}
  ...
  175
\end{euleroutput}
\eulersubheading{Perintah Baru 2}
\begin{eulerprompt}
>450/5^2+980
\end{eulerprompt}
\begin{euleroutput}
  998
\end{euleroutput}
\eulersubheading{Perintah Baru 3}
\begin{eulerprompt}
>mod(289,7)
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulercomment}
\eulersubheading{Perintah Baru 4}
\begin{eulerprompt}
>vectorfield("x*y",0,2,nx=8,ny=9,color=blue):
\end{eulerprompt}
\eulersubheading{Perintah Baru 5}
\begin{eulerprompt}
...
\begin{euleroutput}
          ...
          1         3         2 
\end{euleroutput}
\eulersubheading{Contoh Perhitungan Menggunakan Fungsi-Fungsi Matematika di EMT}
\begin{eulerprompt}
